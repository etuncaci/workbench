...
//#define DEBUG  // simdilik gerek yok
...
//Min and max pulse for ESC
int minPulseRate        = 1000;  //1000
int maxPulseRate        = 2000; // 2000

/* ESC configuration
 *
 */

#define ESC_MIN 40  // 22 idi
#define ESC_MAX 115
#define ESC_TAKEOFF_OFFSET 30  //30 du
...
void initESCs(){
  ...
  a.attach(ESC_A, minPulseRate, maxPulseRate);
  b.attach(ESC_B, minPulseRate, maxPulseRate);
  c.attach(ESC_C, minPulseRate, maxPulseRate);
  d.attach(ESC_D, minPulseRate, maxPulseRate);
